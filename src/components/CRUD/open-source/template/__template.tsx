...
import { CreateOpenSourceSchema } from "@/validators";
import { zodResolver } from "@hookform/resolvers/zod";
import * as React from "react";
import { useForm } from "react-hook-form";
import type { z } from "zod";

interface CEOpenSourceProps {
  title?: string;
  id?: string | null;
  buttonText?: string;
  isOpen: boolean;
...
const CEOpenSource: React.FC<CEOpenSourceProps> = (props) => {
